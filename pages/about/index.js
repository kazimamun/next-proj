...
const index = () => {
    const OurTeam = dynamic(() => import('../../components/AboutComponents/OurTeam/OurTeam.container'),
    { loading: () => <p>loading...</p> }
    );
    const PageTitle = dynamic(() => import('../../components/AboutComponents/PageTitle/PageTitle'));
    return (
        <>
            <PageTitle />
            <div className="about-box-main">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="banner-frame"> <img className="img-thumbnail img-fluid" src="assets/images/about-img.jpg" alt="" />
                            </div>
                        </div>
                    </div>
